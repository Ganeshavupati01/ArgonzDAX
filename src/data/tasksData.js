const tasksData = [
  // ---------------- Time Limit Tasks ----------------
  {
    ...
    subtasks: { total: 10, completed: 9 }, // 90%
    timeLabel: "1 Hour",
    participants: [
  ...
  },
  {
    ...
    subtasks: { total: 20, completed: 17 }, // 85%
    timeLabel: "2 Hours",
    participants: [
  ...
  },
  {
    ...
    subtasks: { total: 12, completed: 12 }, // 100%
  ...
  },
  {
    ...
    category: "Backend Development",
    subtasks: { total: 15, completed: 10 }, // 67%
    timeLabel: "3 Hours",
    participants: [
  ...
  },
  {
    ...
    category: "Testing",
    subtasks: { total: 8, completed: 5 }, // 62%
  ...
  // ---------------- New Tasks ----------------
  {
    ...
    category: "Marketing",
    subtasks: { total: 6, completed: 2 }, // 33%
  ...
  },
  {
    ...
    category: "DevOps",
    subtasks: { total: 7, completed: 3 }, // 43%
