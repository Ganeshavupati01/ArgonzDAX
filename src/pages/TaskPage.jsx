...
export default function TaskPage() {
  ...
  const filtered = tasks
    ...
    .sort((a, b) =>
      sort === "recent"
        ...
        : (b.subtasks.completed / b.subtasks.total) - (a.subtasks.completed / a.subtasks.total)
    );
  ...
  const timeLimitTasks = tasks.filter((t) => t.section === "timeLimit" && searchFilter(t));
  const newTasks = tasks.filter((t) => t.section === "newTask" && searchFilter(t));
